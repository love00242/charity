...
<template>
    ...
    <div
        :class="['share relative origin-left', isOpenShare ? 'scale-x-100  opacity-100 w-auto' : 'scale-x-0 h-0 opacity-0 hidden']">
        <img src="@/assets/icon/close.svg" class="absolute cursor-pointer h-auto" @click="toggleShare"> 
        <!-- duration-100 -->
        <ul
